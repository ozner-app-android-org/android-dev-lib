...
public class ColorPickerBox extends Dialog {
    PortraitColorPickerView view;
    int mInitialColor = 0;

    public ColorPickerBox(Context context, int Color) {
        super(context, android.R.style.Theme_Dialog);
        mInitialColor = Color;
        view = new PortraitColorPickerView(context, new OnColorChangedListener() {
            @Override
    ...
    private class PortraitColorPickerView extends ColorPickerView {
        ...
        public PortraitColorPickerView(Context context, OnColorChangedListener l) {
            ...
            dm = ColorPickerBox.this.getContext().getResources()
                    .getDisplayMetrics();

            int height = (int) (dm.heightPixels * 0.5f) - 36;
            int width = (int) (dm.widthPixels * 0.7f);
            this.mHeight = height;
            this.mWidth = width;
