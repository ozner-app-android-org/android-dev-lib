...
public class WaterPurifier_RO_BLE extends WaterPurifier {
    ...
    private final RO_BLE_FirmwareTools ble_firmwareTools = new RO_BLE_FirmwareTools();

    private final RO_HOST_FirmwareTools host_firmwareTools = new RO_HOST_FirmwareTools();

    private final RO_TFT_FirmwareTools tft_firmwareTools = new RO_TFT_FirmwareTools();
    ...
    public RO_BLE_FirmwareTools ble_firmwareTools() {
        return ble_firmwareTools;
    }

    public RO_HOST_FirmwareTools host_firmwareTools() {
        return host_firmwareTools;
    }

    public RO_TFT_FirmwareTools tft_firmwareTools() {
        return tft_firmwareTools;
    }
    ...
    protected void doSetDeviceIO(BaseDeviceIO oldIO, BaseDeviceIO newIO) {
        if (oldIO != null) {
            ...
            ble_firmwareTools.bind(null);
            host_firmwareTools.bind(null);
            host_firmwareTools.bind(null);
        }
        if (newIO != null) {
            ...
            ble_firmwareTools.bind((BluetoothIO) newIO);
            host_firmwareTools.bind((BluetoothIO) newIO);
            tft_firmwareTools.bind((BluetoothIO) newIO);
        }
    }
